...
export default function SystemDesign() {
    const categories = [
        { title: "Scalability Basics", desc: "Learn how to scale systems efficiently and handle high traffic.", icon: "📈" },
        { title: "Databases", desc: "Understand SQL, NoSQL, indexing, sharding, and replication.", icon: "🗄️" },
        { title: "Load Balancing", desc: "Distribute traffic across servers for optimal performance.", icon: "⚖️" },
        { title: "Caching Strategies", desc: "Implement Redis, Memcached, and CDN caching for speed.", icon: "⚡" },
        { title: "Design Patterns", desc: "Key patterns used in designing scalable and maintainable systems.", icon: "🏗️" },
        { title: "Interview Problems", desc: "Solve FAANG-level system design interview questions.", icon: "🧠" },
    ];
